                ...
                {pages.map((p) => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center border text-xs font-semibold transition-all shrink-0 cursor-pointer active:scale-95 ${
                                isActive
